...
const Dashboard = () => {
  ...
  return (
    <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 m-8">
    <div
    ...
    >
      <div className="p-4 flex items-center bg-white">
        ...
        <div>
          <p className="mb-2 text-sm font-medium text-black-600 dark:text-black-400">
            Total Applications
          </p>
          <p className="text-lg font-semibold text-black-700 dark:text-black-200">
            400
          </p>
        </div>
      </div>
    ...
    >
      <div className="p-4 flex items-center bg-white">
        ...
        <p className="mb-2 text-sm font-medium text-black-600 dark:text-black-400">
          ...
          <p className="text-lg font-semibold text-gray-700 dark:text-black-200">
           270
          </p>
        </div>
      </div>
    ...
    >
      <div className="p-4 flex items-center bg-white">
        ...
        <p className="mb-2 text-sm font-medium text-black-600 dark:text-black-400">
          ...
          <p className="text-lg font-semibold text-gray-700 dark:text-black-200">35</p>
        </div>
      </div>
    </div>
  </div>
